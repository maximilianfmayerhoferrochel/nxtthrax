...
anthracis_check.sh is used with the files in the dhp61 and pl3 folder to use a local blast on your pcr to confirm B. anthracis by searching for the two chromosomal markers dph61 and PL3 in the genomic data. Please see https://www.ncbi.nlm.nih.gov/books/NBK279690/ on how to setup your local blast database using the command line.

MST_script.r uses .fna files as input (from a vcf file generated by parsnp 2.0) to create minimum spanning trees in R. The tree files can be viewed by uploading at https://achtman-lab.github.io/GrapeTree/MSTree_holder.html
